...
const INITIAL_GOALS = [
  { id:1, emp:'Arjun Sharma', empId:'emp1', thrust:'Revenue Growth', title:'Achieve Q1 Sales Target', desc:'Close deals to hit Rs.50L sales target for Q1', uom:'Min', target:50, unit:'Lakhs', weightage:30, status:'Approved', quarter:'Q1', actual:38, checkStatus:'On Track', managerComment:'Good progress, keep it up', locked:true, shared:false, sharedFrom:null },
  ...
  { id:9, emp:'Rohit Kumar', empId:'emp3', thrust:'Revenue Growth', title:'Pipeline Development', desc:'Build pipeline worth Rs.1.2Cr', uom:'Min', target:120, unit:'Lakhs', weightage:40, status:'Pending', quarter:'Q1', actual:null, checkStatus:'Not Started', managerComment:'', locked:false, shared:false, sharedFrom:null },
...
module.exports = { DEMO_CREDENTIALS, buildSeedDatabase };
