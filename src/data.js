...
export const SCHEDULE = [
  { period:'Goal Setting',   window:'1-17 May 2026', action:'Goal Creation, Submission & Approval', status:'done'   },
  { period:'Q1 Check-in',    window:'May 17 onward', action:'Progress Update — Planned vs. Actual', status:'active' },
